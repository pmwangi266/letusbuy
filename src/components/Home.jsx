...
const Home = () => {
  ...
  useEffect(() => {
    const handleResize = () => {
      ...
      // Auto-close mobile categories on resize to larger screens
      if (window.innerWidth > 1024 && showMobileCategories) {
  ...
  return (
    <div className="landing-page">
      ...
      {windowWidth <= 1024 && (
        ...
        >
          {showMobileCategories ? '× Close Categories' : '☰ Browse Categories'}
        </button>
      )}
